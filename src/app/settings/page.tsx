...
export default function SettingsPage() {
  const { resetData, exportData, importData } = useNutritionStore();
  ...
  function handleExport() {
    ...
    link.href = url;
    link.download = `macrotrack-export-${new Date().toISOString().slice(0, 10)}.json`;
    link.click();
    ...
    <AppShell>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-500">
          Gestion locale de tes données MVP.
        </p>
      </div>
